 ...
 */
public class Dialog_Get_Premium extends DialogFragment {

    PremiumListener mListener;
...
//Set ClickListener
        ibSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog_Get_Premium.this.getDialog().cancel();
                mListener.onPremiumSelected();
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (PremiumListener) activity;
